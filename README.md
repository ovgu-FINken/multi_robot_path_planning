...
-This algorithm works very well with upto 8 robots. with the increase in number of robots, number of collision increases too (with 16 robot there were ~3       collisions)
